...
export const UploadedFileGridItem: React.FC<UploadedFileGridItemProps> = ({
  file,
  onRemove,
  onEditSvg,
}) => {
  ...
  return (
    <div className="relative group border rounded-lg overflow-hidden bg-background flex flex-col">
      ...
      <div
        ...
        onClick={
          canPreview && !isImage ? () => handleFilePreview(file.url) : undefined
        }
        title={
...
export const QueuedFileGridItem: React.FC<QueuedFileGridItemProps> = ({
  queuedFile,
  onRemove,
  onEditSvg,
}) => {
  ...
  return (
    <div className="relative group border rounded-lg overflow-hidden bg-background flex flex-col">
      ...
      {/* File Info */}
      <div className="p-3 flex flex-col gap-1 min-h-[64px]0">
        <div className="flex items-start gap-1.5">
          ...
          {queuedFile.status === "error" && (
            <span className="text-[10px] text-destructive shrink-0 mt-0.5">
              Error
            </span>
          )}
        </div>
