...
export function InfoCard({ icon, title, description, ...props }: InfoCardProps) {
    ...
    return (
        <E
            ...
            data-card
            className={cn(
                'block rounded-xl bg-transparent p-4 text-fd-card-foreground transition-colors @max-lg:col-span-full',
