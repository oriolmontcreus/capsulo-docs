  ...
  return (
    <Label
      ...
      className={cn(
        ...
        "has-data-[state=checked]:bg-primary/5 has-data-[state=checked]:border-primary dark:has-data-[state=checked]:bg-primary/10 min-h-[24px] font-normal",
        className,
      )}
      {...props}
    >
...
function FieldError({
  ...
  return (
    <div
      ...
      className={cn(
        "flex items-center gap-2 text-destructive text-sm font-normal",
        className,
      )}
      {...props}
    >
