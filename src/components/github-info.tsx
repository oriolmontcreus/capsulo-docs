...
export async function GithubInfo({
  ...
  return (
    <a
      ...
      {...props}
      className={cn(
        'flex flex-row items-center gap-1.5 px-2 py-1.5 h-8 rounded-lg text-sm text-fd-foreground/80 transition-colors hover:text-fd-accent-foreground hover:bg-fd-accent no-underline!',
        props.className,
      )}
    >
      ...
      <p className="flex text-xs items-center gap-1 text-fd-muted-foreground whitespace-nowrap">
